...
import { BadgeIndianRupee, BarChart3, Bell, CalendarClock, Film, Gift, Settings, ShieldCheck, UserRound } from "lucide-react";

const items = [
  { label: "Overview", href: "#overview", icon: BarChart3 },
  { label: "Profile", href: "#profile", icon: UserRound },
  { label: "Requests", href: "#booking-requests", icon: CalendarClock },
